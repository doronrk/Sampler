...
#ifndef SYNCSYNTHESISER_H_INCLUDED
#define SYNCSYNTHESISER_H_INCLUDED
 ...
 */
class SyncSynthesiserSound    : public ReferenceCountedObject
{
protected:
    //==============================================================================
    SyncSynthesiserSound();
    
public:
    /** Destructor. */
    virtual ~SyncSynthesiserSound();
    ...
    typedef ReferenceCountedObjectPtr<SyncSynthesiserSound> Ptr;
    
    
private:
    //==============================================================================
    JUCE_LEAK_DETECTOR (SyncSynthesiserSound)
};
 ...
 */
class JUCE_API  SyncSynthesiserVoice
{
public:
    //==============================================================================
    /** Creates a voice. */
    SyncSynthesiserVoice();
    
    /** Destructor. */
    virtual ~SyncSynthesiserVoice();
     ...
     */
    SyncSynthesiserSound::Ptr getCurrentlyPlayingSound() const noexcept     { return currentlyPlayingSound; }
     ...
     */
    virtual bool canPlaySound (SyncSynthesiserSound*) = 0;
    ...
    bool wasStartedBefore (const SyncSynthesiserVoice& other) const noexcept;
...
private:
    //==============================================================================
    friend class SyncSynthesiser;
    
    double currentSampleRate;
    int currentlyPlayingNote;
    uint32 noteOnTime;
    SyncSynthesiserSound::Ptr currentlyPlayingSound;
    ...
    JUCE_LEAK_DETECTOR (SyncSynthesiserVoice)
};
...
public:
    ...
    SyncSynthesiserVoice* getVoice (int index) const;
    ...
    /** Adds a new voice to the synth.
     ...
     voice.
     */
    SyncSynthesiserVoice* addVoice (SyncSynthesiserVoice* newVoice);
    ...
    SyncSynthesiserSound* getSound (int index) const noexcept           { return sounds [index]; }
     ...
     */
    SyncSynthesiserSound* addSound (const SyncSynthesiserSound::Ptr& newSound);
...
protected:
    ...
    OwnedArray<SyncSynthesiserVoice> voices;
    ReferenceCountedArray<SyncSynthesiserSound> sounds;
     ...
     */
    virtual SyncSynthesiserVoice* findFreeVoice (SyncSynthesiserSound* soundToPlay,
                                             int midiChannel,
                                             int midiNoteNumber,
     ...
     */
    virtual SyncSynthesiserVoice* findVoiceToSteal (SyncSynthesiserSound* soundToPlay,
                                                int midiChannel,
     ...
     */
    void startVoice (SyncSynthesiserVoice* voice,
                     SyncSynthesiserSound* sound,
                     int midiChannel,
                     int midiNoteNumber,
                     float velocity);
...
private:
    ...
    void stopVoice (SyncSynthesiserVoice*, float velocity, bool allowTailOff);
    
#if JUCE_CATCH_DEPRECATED_CODE_MISUSE
    // Note the new parameters for these methods.
    virtual int findFreeVoice (const bool) const { return 0; }
    virtual int noteOff (int, int, int) { return 0; }
    virtual int findFreeVoice (SyncSynthesiserSound*, const bool) { return 0; }
    virtual int findVoiceToSteal (SyncSynthesiserSound*) const { return 0; }
#endif
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (SyncSynthesiser)
};


#endif  // SYNCSYNTHESISER_H_INCLUDED
